...
function HealthcareSection() {
  const HealthCareProduct1 = healthCareData; // Import the product data from the data file
  ...
  <section>
    <div className="relative block w-full">
      <picture>
        <img className="block w-full h-full object-cover mt-0" src="//www.lifelongindiaonline.com/cdn/shop/files/Homepage_1.png?v=1727800656" alt="HomeCollectionSection" />
      </picture>
      <div alt ="Home-Collection-Wrapper" className="absolute inset-0 flex items-center md:justify-start text-center md:text-left lg: z-10">
        <div className="flex justify-between items-center w-full h-auto">
          <div alt="leftsection" className="w-[49%] flex flex-col md:justify-start lg:justify-start gap-4 pl-20 pt-55">
            <h2 className="flex max-w-90 text-white text-4xl font-light">Health & Fitness Equipments</h2>
...
export default HealthcareSection; // Export HealthcareSection as a named export
        ...
        <header>
            <div className="h-[80px] w-auto mx-0 px-4 py-4 flex justify-between items-center bg-black text-white border-b-[0.5px] border-#3a3a3a" >
                <div className="w-43 flex justify-start items-center gap-x-4" >
                    <Link to="/">
                        <img className="max-h-10 ml-20" src={`${import.meta.env.BASE_URL}lifelong-logo.svg`} alt="logo" />
                    </Link>
                </div>
                ...
                <div className="w-[136px] h-40 flex justify-end items-center gap-x-4 mr-20">
                    <Link to="/Login">
                        <svg width="18" height="18" viewBox="0 0 18 18" fill="none" xmlns="http://www.w3.org/2000/svg">
                            <circle cx="9.5" cy="5.5" r="4.75" stroke="white" strokeWidth="1.5"></circle> 
                            <path d="M1 18V17C1 14.7909 2.79086 13 5 13H13C15.2091 13 17 14.7909 17 17V18" stroke="white" strokeWidth="1.5"></path>
                        </svg>
                    </Link>
                    <Link to="/CartPage">
